      ...
      <div className="contact-content">
        ...
        <div className="contact-info-items">
          <div className="address-header">
            <Image src={Address.src} width={77} height={77} alt="map" />
            <h3>
              м. Рівне вул.
              <br />
              П.Могили 28
          ...
          <div className="details-block">
            <div className="flex">
              <Image src={Phone.src} alt="Phone" width={44} height={44} />
              <Link href="tel:+380978232828" type="tel">
                +380 (97) 823 28 28
              </Link>
            </div>
            <div className="flex">
              <Image src={Clock.src} width={44} height={44} alt="clock" />
              <span>
                Пн-Пт : 9:00 - 20:30 <br /> Сб : 9:00 - 19:00 <br /> Нд : 9:00 -
                15:00
              </span>
            </div>
          </div>
